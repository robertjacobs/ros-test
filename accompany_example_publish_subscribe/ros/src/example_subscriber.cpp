...
void ExampleSubscriber::init()
{
	...
	*/
	string_subscriber_ = node_.subscribe("infrared_sensor_distance", 10, &ExampleSubscriber::receiveCallback, this);
}


void ExampleSubscriber::receiveCallback(const std_msgs::Int32::ConstPtr& msg)
{
	ROS_INFO("[%i]", msg->data);
}
