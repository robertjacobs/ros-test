"""autogenerated by genpy from action_test/MessageActionFeedback.msg. Do not edit."""
import sys
...
class MessageActionFeedback(genpy.Message):
  _md5sum = "f0dc511aac88b7d008039f63e897b1e5"
  _type = "action_test/MessageActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_test/MessageFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MessageActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = action_test.msg.MessageFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = action_test.msg.MessageFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.feedback.percentageDone))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.percentageDone,) = _struct_f.unpack(str[start:end])
      return self
