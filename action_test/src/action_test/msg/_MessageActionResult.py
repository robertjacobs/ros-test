"""autogenerated by genpy from action_test/MessageActionResult.msg. Do not edit."""
import sys
...
class MessageActionResult(genpy.Message):
  _md5sum = "ff0cfd62a599a587006f0b183505927a"
  _type = "action_test/MessageActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_test/MessageResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MessageActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action_test.msg.MessageResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_test.msg.MessageResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_d.pack(self.result.itemsWashed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.itemsWashed,) = _struct_d.unpack(str[start:end])
      return self
