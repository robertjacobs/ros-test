"""autogenerated by genpy from action_test/MessageAction.msg. Do not edit."""
import sys
...
class MessageAction(genpy.Message):
  _md5sum = "da60e36bcd9d308c135d285ccd2d629c"
  _type = "action_test/MessageAction"
...
"""
  ...
  _slot_types = ['action_test/MessageActionGoal','action_test/MessageActionResult','action_test/MessageActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MessageAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = action_test.msg.MessageActionGoal()
      if self.action_result is None:
        self.action_result = action_test.msg.MessageActionResult()
      if self.action_feedback is None:
        self.action_feedback = action_test.msg.MessageActionFeedback()
    else:
      self.action_goal = action_test.msg.MessageActionGoal()
      self.action_result = action_test.msg.MessageActionResult()
      self.action_feedback = action_test.msg.MessageActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_d3I.pack(_x.action_goal.goal.number, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_d3I.pack(_x.action_result.result.itemsWashed, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.action_feedback.feedback.percentageDone))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.number, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.itemsWashed, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.percentageDone,) = _struct_f.unpack(str[start:end])
      return self
